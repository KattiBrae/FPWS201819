...
%\begin{equation*}
%	 \frac{3}{8} \cdot \frac{8}{3} \pi r^2 \cdot \frac{1}{m_0 (\sfrac{Eg}{m_0})^2}
%	 \left[ 2 + \frac{E}{(Eg-E)^2}
%	 \left( \frac{1}{(\sfrac{Eg}{m_0})^2} +
%	 \left(1- \frac{2}{\sfrac{Eg}{m_0}} \right)
%	 \frac{Eg-E}{Eg} \right) \right]
%	 \cdot c+h
%\end{equation*}
Rückstreuung:
\begin{equation}
