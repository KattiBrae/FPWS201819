...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{images/spektrum_europium.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{images/spektrum_europium_kali.pdf}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.8\textwidth]{images/kalibration.pdf}
