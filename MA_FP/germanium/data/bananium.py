...
#    ax.legend(fancybox=True, ncol=1)
    ...
    plt.savefig('bananium_markiert.pdf')
...
if __name__=="__main__":
    ...
    y = np.loadtxt('bananium.txt', unpack=True,delimiter=' ')
...
#    yachse = ufloat(-1.22364356, 1.66905256e-01)
    ...
    peaks = sig.find_peaks(y, prominence = 15)
#    print(peaks) 60,   64,   96,  108,  147,  150,  178,  206,
    peaks = [  248,  286, 357,
        369,  379,  419,  429,  453,  459,  487,  490,  500,  505,  534,
        557,  602,  608,  625,  630,  642,  668,  672,  682,  708,  720,
        728,  766,  785,  798,  808,  850,  904,  931,  961,  978,  994,
       1026, 1058, 1117, 1157, 1227, 1253, 1291, 1316, 1389, 1431, 1706,
       2470, 2944, 7055]
