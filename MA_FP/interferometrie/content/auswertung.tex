...
Bei einer Rotation um $\SI{11}{\degree}$ und einer Wandstärke $T = \SI{1}{\milli \meter} $ wurden die in Tabelle \ref{tab:M} zu sehenden Anzahl an Interferenzmaxima gemessen.
