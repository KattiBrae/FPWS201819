...
%  		I_{\text{Int.}} 	&& 	\propto	 \langle 2 E_1 E_2 \rangle &&\\
%		= \langle 2 E_0^2 \sin{(\phi)} \cos{(\phi)} \cos{(\omega t )} \cos{(\omega t + \delta)}\rangle 															&& \\
...
\begin{equation}
	K(\phi) \propto = | 2 \cos{(\phi)} \sin{(\phi)} | = |\sin{(2\phi)}|. % \frac{(1+2\cos{(\phi)} \sin{(\phi)}) - (1-2\cos{(\phi)} \sin{(\phi)})} {(1+\cos{(\phi)} \sin{(\phi)}) + (1-2\cos{(\phi)} \sin{(\phi)})} \quad
