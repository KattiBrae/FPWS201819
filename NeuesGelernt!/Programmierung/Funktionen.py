...
############################## Main
if __name__ == '__main__':                                                                      #Anfang Main Funktion. Die Main muss als letztes kommen.
    import numpy as np
    import sympy
...
#Bandlücke abstand zwichen Maxima (immer zwei gehören zusammen)
    x1=u(1130,3440)                                                                              #Funktion u wird aufgerufen und 2 werte übergeben. u lifert einen Wert zurück
    x2=u(1300,3420)
    x3=u(1430,3390)

    i(x1,x2,x3,D)                                                                                #Funktion i wird aufgerufen
    #
    x4=u(3930,6820)
    x5=u(4160,6770)
    x6=u(4410,6730)
