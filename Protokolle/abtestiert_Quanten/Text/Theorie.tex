...
%Zeitunabhängige quantenmechanische Eigenzustände sind dauerhaft, während mechanische Eigenzustände zeitunabhängig sind und damit instabil.
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{bändermodell2.png}
