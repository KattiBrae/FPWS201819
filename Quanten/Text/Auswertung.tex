...
\FloatBarrier
In den Graphen \ref{fig.2} und \ref{fig.2} \textbf{\huge{DAS IST ZWEI MAL DER GLEICHE PLOT (4\&4)}}} werden die Resonanzfrequenzen einer jeden Messreihe von 1 bis n nummeriert und anschließend gegen die Frequenz aufgetragen.
...
\begin{align*}
  a&=\SI{168692.913\pm253.977}{EINHEIT}\\
  b&=\SI{8.566\pm1.995}{EINHEIT}.\\
\end{align*}
%################Bild#####################
\begin{figure}[h!]
  \centering
...
\begin{figure}[h!]
  ...
  \caption{Dispersionsrelation für Schallwellen X\textbf{\huge{WOFÜR STEHT DAS X?}} und die Theoriekurve eines quantenmechanischen Teilchens im Potenzialtopf}
  \label{fig.Aufgabe2}
\end{figure}
...
Dazu wird ein Rohr der Länge $\SI{12 \cdot }{mm}$ mit Blenden unterteilt.
...
\begin{figure}[h!]
  ...
  \label{fig.Aufgabe3}
\end{figure}
\textbf{\huge{Welche Gerade steht für welchen Aufbau oder für welche Bandlücke? Im Protokoll sieht man die Spektren ja nicht und so sind die Linien eher sinnlos/verwirrend}}
\FloatBarrier
...
Die Rohrlänge wird zwischen $\SI{8 \cdot 50}{mm}$, $\SI{10 \cdot 50}{mm}$ und $\SI{12 \cdot 50}{mm}$ variiert.
...
Es werden für $\SI{2 \cdot 50}{mm}$ Rohrlänge unterschiedliche Blendendurchmesser untersucht. Der Blendendurchmesser soll die Stärke von Bindungen zwischen Atomen symbolisieren.
