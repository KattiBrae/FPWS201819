...
Da ein Strahlungsübergang zwischen zwei Zuständen $\alpha$ und $\beta$ betrachtet werden soll wird für die Lösung eine Linearkombination dieser Zustände gewählt.%Die Lösung $\psi$ beschreibt den Übergang zwischen den Energieniveaus $\alpha$ und $\beta$.
\begin{align*}
