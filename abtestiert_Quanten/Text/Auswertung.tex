...
In den Abbildungen \ref{fig.RedBandSchem} und \ref{fig.RedBandSchem75} werden die Abbildungen \ref{fig.Aufgabe5} und \ref{fig.Aufgabe575} als reduziertes Bandschema dargestellt.
